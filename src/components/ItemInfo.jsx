const ItemInfo = ({ quantity, updateQuantity, updateCartQuantity }) => {
    const removeItem = () => {
        if (quantity > 0) {
    ...
    return <div className="max-md:p-8">
        ...
        <div className="mt-4 flex">
            ...
            <button onClick={() => updateCartQuantity(quantity)} className="bg-orange-600 rounded-md text-slate-950 font-bold text-xl ml-4 w-2/3 flex justify-center items-center">
