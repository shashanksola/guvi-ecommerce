const SideBarModal = ({ visible, updateVisible }) => {
    ...
    return <div className="fixed inset-0 bg-black bg-opacity-80 backdrop-blur-sm overscroll-none z-20">
        <div className="bg-slate-50 w-1/2 h-full p-8">
            ...
            <p className="text-slate-800">Collections</p>
            <p className="text-slate-800">Men</p>
            <p className="text-slate-800">Women</p>
